...
import Iconsar from "@expo/vector-icons/Entypo";
...
export default function Shop() {
  ...
  return (
    <>
      <View className="absolute top-[81vh] left-[50%] transform -translate-x-1/2 z-10 flex-row items-center px-4">
        <TouchableOpacity
          className="flex-row items-center mt-3 bg-[#ff6b6b] shadow-xl rounded-xl  px-4 py-2"
        ...
        <TouchableOpacity
          ...
          className="flex-row  items-center mt-3 bg-[#ff6b6b] shadow-xl rounded-xl  px-4 py-2 ml-2"
        >
          <Text className="text-white text-lg">Sort</Text>
      ...
      <View className="flex-1 bg-gray-100">
          ...
          <View className="flex-row justify-between items-center w-full gap-4">
            ...
            >
              <View>
                ...
                <Iconsar name="shopping-cart" size={24} color="#929292" />
        ...
        >
          ...
          >
            ...
            >
              <Text className="text-xl font-bold mb-5">Filter</Text>
              ...
              <View className="flex-row mt-6">
                <TouchableOpacity
                  className="flex-1 border rounded-xl py-3 mr-2 items-center"
                  onPress={() => {
        ...
        >
          ...
          >
            ...
            <Pressable
              ...
              onPress={(e) => e.stopPropagation()}
            >
              <Text className="text-xl font-bold mb-5">Sort By</Text>
